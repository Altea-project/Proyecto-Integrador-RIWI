// repositories/interestRepository.js
...
// directamente), porque interestService controla el BEGIN/COMMIT/ROLLBACK.

// Trae al coder con FOR UPDATE para bloquear la fila mientras dura la
// transacción (evita condición de carrera si dos reclutadores hacen clic
// casi al mismo tiempo sobre el mismo coder).
...
// Datos del reclutador que se necesitan para el correo (nombre, empresa,
// email de contacto). No se duplican en recruiter_interests — PDR 3.2.
