...
const getProjectByIdRoutes = require('./routes/getProjectByIdRoutes'); // HU-13 · T4: GET /projects/:id (detalle)
...
// GET /api/projects/:id (HU-13 · T4: detalle). Se monta DESPUÉS de
// getProjectsRoutes a propósito: esa contiene GET /projects/pending,
// y "/projects/:id" coincide con cualquier segmento -incluido
// "pending"-, así que si este router se montara antes, "pending"
// terminaría entrando aquí como si fuera un id (ver nota en
