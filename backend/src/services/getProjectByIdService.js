...
// HU-13 · T2 — GET /projects/:id (detalle de un proyecto).
//
...
/**
 * (T2 - HU-13) Error de dominio para "el proyecto no existe". El
 * controller lo traduce a 404 (CA-03); cualquier otro error sigue de
 * largo hacia el manejador de errores centralizado (500).
 */
...
/**
 * (T2 - HU-13) Arma el detalle de un proyecto para la vista
 * ProjectDetailView.
 *
 * - coderName: nombre de quién hizo el proyecto (ya resuelto por JOIN,
 *   igual que en la galería).
