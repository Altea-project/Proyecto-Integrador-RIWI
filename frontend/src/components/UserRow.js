    ...
    <tr class="group border-b border-border-default/40 hover:bg-[#161B26]/40 transition-all duration-300">
      ...
      <td class="py-6 px-10 text-right">
        <div class="flex justify-end gap-3 opacity-30 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
          ${assignTlButton}
          <button class="p-2.5 rounded-xl bg-white/5 border border-border-default text-text-tertiary hover:text-white hover:bg-white/10 hover:border-white/20 transition-all active:scale-90" title="Editar Miembro">
          ...
          <button class="p-2.5 rounded-xl bg-[#EF4444]/5 border border-[#EF4444]/10 text-text-tertiary hover:text-white hover:bg-[#EF4444] hover:border-[#EF4444]/40 transition-all active:scale-90" title="Borrar de Altea">
